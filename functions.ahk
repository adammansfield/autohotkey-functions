...
/**
  @brief Sets a variable to the sum of itself plus the given value.
  */
...
/**
  @brief Sets a variable to itself divided by the given value.
  */
EnvDiv(Var, Value)
{
  EnvDiv, %Var%, %Value%
...
/**
  @brief Sets a variable to itself times the given value.
  */
EnvMult(Var, Value)
{
  EnvMult, %Var%, %Value%
...
/**
  @brief Writes a value to a variable contained in the environment.
  */
EnvSet(EnvVar, Value)
{
  EnvSet, %EnvVar%, %Value%
...
/**
  @brief Sets a variable to itself minus the given value (can also compare date-time values).
  */
...
/**
  @brief Notifies the OS and all running applications that environment variable(s) have changed.
  */
EnvUpdate()
{
  EnvUpdate
...
/**
  @brief Returns the count of how many characters are in a string.
  */
...
/**
  @brief Returns an uppercase string.
  */
